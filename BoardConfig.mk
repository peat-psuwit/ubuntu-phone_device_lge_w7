...
TARGET_KERNEL_CONFIG := ubuntu-w7_defconfig
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 console=tty0 androidboot.console=ttyHSL0 user_debug=31 msm_rtb.filter=0x37 androidboot.hardware=w7
